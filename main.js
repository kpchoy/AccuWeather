  ...
  function get5DayForecast(zip) {
    ...
    $.getJSON(link)
      .done(function(data) {
        ...
        let date2 = new Date(data.DailyForecasts[1].Date);
        let date2Name = days[date2.getDay()];
        let day2IconPhrase = data.DailyForecasts[1].Day.IconPhrase;
        let day2Icon = iconLinkGen(data.DailyForecasts[1].Day.Icon);
        let temp2Min = data.DailyForecasts[1].Temperature.Minimum.Value;
        let temp2Max = data.DailyForecasts[1].Temperature.Maximum.Value;
        ...
        let date3 = new Date(data.DailyForecasts[2].Date);
        let date3Name = days[date3.getDay()];
        let day3IconPhrase = data.DailyForecasts[2].Day.IconPhrase;
        let day3Icon = iconLinkGen(data.DailyForecasts[2].Day.Icon);
        let temp3Min = data.DailyForecasts[2].Temperature.Minimum.Value;
        let temp3Max = data.DailyForecasts[2].Temperature.Maximum.Value;
